CLASS zcl_generate_travel_data_103 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_103 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA itab TYPE TABLE OF ztravel_103.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_103.

*   insert the new table entries
    INSERT ztravel_103 FROM TABLE @itab.
